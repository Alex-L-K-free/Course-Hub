# Middle Занятие 11. Практика файлы
# Пример для чего нужны файлы:
# 1. Пишем интерфейс для убравления выбором команд
# 2. Разбираем где программе хранить данные после выключения програамы
# 3. Реализуем хранилище на базе .txt файла
