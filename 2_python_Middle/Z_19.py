# Занятие 19. Практика часть 2
# Завершаем программу с тестами для школы
# 1. Реализуем подгрузку данных из файла при запуске
# 2. Дописываем функции для администратора
